  ...
  const categories: Category[] = [
    {
      ...
      items: [
        ...
        '弁護士', '教師', '芸人', 'YouTuber', '漁師',
        '農家', '建築士', '消防士', '救急隊員', '薬剤師',
        '看護師', '歯科医', '精神科医', '心理カウンセラー', '探偵',
        '泥棒', 'ハッカー', '傭兵', 'スパイ', '忍者',
        '元武士', '剣客', '商人', '冒険家', '船乗り',
        '海賊', '武道家', 'プロゲーマー', 'アニメーター', 'マンガ家',
        'イラストレーター', '音楽家', 'ピアニスト', '歌手', '俳優',
        'モデル', 'プロスポーツ選手', 'サッカー選手', '野球選手', '格闘家',
        '柔道家', 'ボクサー', 'バレーダンサー', 'シェフ', 'パティシエ',
        'バーテンダー', 'ソムリエ', '元ヤクザ', '元カルト信者', '難民',
        '富豪の御曹司', '破産した実業家', '宗教家', '政治家', '外交官',
        '通訳', 'ジャーナリスト', '戦場カメラマン', 'NGO職員', '獣医師',
        '森林官', '潜水士', 'パイロット', 'AI研究者', 'ゲームデザイナー',
        '株式トレーダー', '葬儀屋', '霊媒師', '骨董商', '古書店主',
        '図書館司書', '元死刑囚', '宇宙飛行士候補', '保険外交員', '移民一世',
        '老舗旅館の若旦那', '花街育ち', '修道士', '元プロ野球選手', '山伏',
        '離島育ちの漁師の息子', '元アイドル', '現役大学院生', '売れっ子占い師', '孤独な天文学者',
      ],
    },
    {
      key: 'looks',
      ...
      items: [
        ...
        '筋骨隆々', '太り気味', '猫背', 'いつも黒服', '無精ひげ',
        '整えられたひげ', 'くせっ毛', '長髪', 'ショートカット', '坊主頭',
        '三つ編み', '白髪交じり', '金髪', '赤毛', '巻き毛',
        '目つきが鋭い', '柔らかい目元', '高い鼻', 'そばかす', 'ほくろが多い',
        '大きな口', '厚い唇', '大きな耳', '義手', '義足',
        '車椅子利用者', '常に帽子', 'マスクが手放せない', 'サングラス常用',
        '指が欠けている', '首に傷がある', '常に手袋', '背中に古傷',
        '足を引きずっている', '金歯が一本ある', '口元に泣きぼくろ',
        '左右の目の色が違う', '額が広い', '顎が細い', '丸顔', '面長',
        '鷲鼻', '平たい顔', '浅黒い肌', '陶磁器のような肌', '赤ら顔',
        '首が短い', '肩幅が広い', 'なで肩', 'O脚', 'X脚',
        '長い指', '手のひらが大きい', '爪を常に噛んでいる', '目の下にクマ',
        '表情が乏しい', '常に汗をかいている', '体臭が独特', '煙草の匂いがする',
        '老け顔', '若く見える', '左利き', '吃音がある', '声が低い',
        '声が高い', 'ポニーテール', '編み込みヘア', '七三分け', '常にスーツ',
        '常にジャージ', '和服が似合う', '目が細い', '二重まぶた', '一重まぶた',
        '小さな口', '細い眉', '太い眉', '薄い眉', '耳たぶが大きい',
        '首が長い', 'X脚', '爪が長い', '異様に白い歯', '腕が長い',
        '手首が細い', '顔が左右非対称', '生え際が薄い', '笑うとえくぼ', '瞳が大きい',
      ],
    },
    {
      key: 'personality',
      ...
      items: [
        ...
        '好奇心旺盛', '慎重', '衝動的', '頑固', '柔軟',
        '優しい', '冷酷', '感情的', '論理的', '直感的',
        '夢想家', '現実主義', '孤独を好む', '人懐っこい', '嫉妬深い',
        '寛大', '自己中心的', '自己犠牲的', '負けず嫌い', '諦めが早い',
        '誠実', '不誠実', 'おっちょこちょい', '几帳面', '神経質',
        '大らか', '悲観的', '野心家', '謙虚', '傲慢',
        'お節介', '無関心', '執念深い', '忘れっぽい', '記憶力が鋭い',
        'お金に細かい', '太っ腹', '冒険好き', '安定志向', '感謝の気持ちが強い',
        '恩を忘れない', '恨みがましい', '依存心が強い', '自立心が強い',
        '責任感が強い', '責任逃れをする', '嘘をつくのが上手い', '正義感が強い',
        '反抗心が強い', '従順', '妄想癖がある', 'プレッシャーに強い',
        'プレッシャーに弱い', 'ユーモアがある', '冗談が苦手', '自虐的',
        '罪悪感を持ちやすい', '道徳観が強い', '道徳に無頓着', '宗教心が強い',
        '芸術的センスがある', '運動神経が鋭い', '不器用', '手先が器用',
        '記録魔', '計画魔', '行き当たりばったり', '人の顔色を窺いすぎる',
        '全く空気を読まない', '共感力が高い', '共感力が低い',
        '熱しやすく冷めやすい', '一途', '多趣味', '凝り性',
        '話し上手', '聞き上手', '説教好き', '悪口を言わない', '愚痴が多い',
        '自分を過大評価する', '自分を過小評価する', '変化を恐れる', '変化を好む',
        '秩序を重んじる', '規則を破りたがる', '人を信じやすい', '疑り深い',
      ],
    },
  ]
